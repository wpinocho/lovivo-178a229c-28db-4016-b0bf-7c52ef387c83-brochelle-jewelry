...
export const NewsletterSection = () => {
  return (
    <HeadlessNewsletter>
      {(logic) => (
        <section className="desert-gradient py-20 border-y border-border/50">
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <Button 
                    type="submit"
                    disabled={logic.isSubmitting}
                    className="sm:w-auto bg-primary hover:bg-primary/90 text-primary-foreground transition-luxury"
                  >
